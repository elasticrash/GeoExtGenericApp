/**
 * Created by stefanos on 6/5/2015.
 */
/**
...
Ext.define('Elpho.tools.vector.SaveChangesButton', {
    ...
    insertfeaturesXMLS: function()
    {
        ...
        var laytypes = ["bio", "pop","pge","water","drill","irrnet"];
        var layersnames = ["D_BIOFARM", "D_POP_PROD","D_PGE_PROD","D_WATER","D_DRILL","D_IRR_NET"];
        ...
        Ext.each(me.targetVectorLayer.features, function(feat) {
            if (feat.geometry !== null) {
                ...
                if(gmlgeometry!=null) {
                    ...
                    var lindex = laytypes.indexOf(feat.ltype);
                    commitment.action[i].table[i].name = 'ELPHO:' + layersnames[lindex];
